...
export default function Model(props) {
    ...
    useFrame(() => {
        ...
        computerWireframe.current.position.x = THREE.MathUtils.lerp(computerWireframe.current.position.x, hovered ? 2.39 : 1.39, 0.1);
    })

	return (
		<group ref={group} {...props} rotation={[0, 0.5, 0.2]} position={[2, -6, -8]} onPointerOver={() => setHover(true)}
